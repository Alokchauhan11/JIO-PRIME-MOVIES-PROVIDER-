...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002028576263'))
...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://ibb.co/kS0VKQ8'))
REACTIONS = ["❤️‍🔥", "✨", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "disabled-vivienne-jamjam-f9415d4d.koyeb.app/")
